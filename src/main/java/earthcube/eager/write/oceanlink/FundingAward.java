...
public class FundingAward {
	...
	public String toRdfXml ( FundingAwardData fundingAward ) {
		...
		String output = 
		  ...
		  "       <hasStartDate rdf:datatype=\"time:Instant\">" + fundingAward.getStartInstant() + "</startsAt>" + Constants.newLine +
		  "       <hasEndDate rdf:datatype=\"time:Instant\">" + fundingAward.getEndInstant() + "</endsAt>" + Constants.newLine +
		  ...
		  "<rdf:Description rdf:nodeID=\"" + fundingAward.getOwlTimeID() + "\">" + Constants.newLine +
          "   <rdf:type rdf:resource=\"http://www.w3.org/2006/time#Instant\"/>" + Constants.newLine +
          "   <time:inXSDDateTime rdf:datatype=\"xsd:dateTime\">" + fundingAward.getStartDate + "</time:inXSDDateTime>" + Constants.newLine +
          "</rdf:Description>";
