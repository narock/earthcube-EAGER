...
public class AwardAmount {
	...
	public String toRdfXml ( String awardAmountUri, String awardAmount ) {
		...
		String output =
		  ...
		  "<rdf:RDF xmlns=\"http://schema.oceanlink.org/funding-award#\"" + Constants.newLine +
		  ...
		  "   xml:base=\"http://schema.oceanlink.org/funding-award\">" + Constants.newLine +
		  "   <rdf:Description rdf:about=\"" + awardAmountUri + "\">" + Constants.newLine +
		  "      <rdf:type rdf:resource=\"AwardAmount\"/>" + Constants.newLine +
		  "      <hasCurrencyCode rdf:resource=\"http://www.oceanlink.org/CurrencyCode/USD\"/>" + Constants.newLine;
