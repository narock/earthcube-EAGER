...
public class PersonName {
	...
	public String toRdfXml ( PersonNameData p ) {
		...
		String output = 
			...
			"   <rdf:Description rdf:about=\"http://www.oceanlink.org/lod/PersonName/" + p.getPersonName() +"\">" + Constants.newLine +
			"      <rdf:type rdf:resource=\"PersonName\"/>" + Constants.newLine +
			"      <rdfs:subClassOf rdf:resource=\"PersonalInfoValue\"/>" + Constants.newLine +
			"      <fullNameAsString rdf:datatype=\"xsd:string\">" + p.getFullName + "</fullNameAsString>" + Constants.newLine +
			"      <firstOrGivenName rdf:datatype=\"xsd:string\">" + p.getFirstName + "</firstOrGivenName>" + Constants.newLine +
			"      <familyOrSurname rdf:datatype=\"xsd:string\">" + p.getSurname + "</familyOrSurname>" + Constants.newLine +
